...
export default function Register() {
  ...
  return (
    <div style={{ maxWidth: 400, margin: '80px auto', padding: '0 20px' }}>
      <h1 style={{ fontSize: 32, fontWeight: 500, marginBottom: 8 }}>Create account</h1>
      <p style={{ color: '#6b6375', marginBottom: 32 }}>Join to book tickets or list events.</p>

      <form onSubmit={handleSubmit}>
        <div style={{ marginBottom: 16 }}>
          <label style={{ display: 'block', marginBottom: 6, fontSize: 14 }}>Name</label>
          <input
            type="text"
            value={name}
        ...
        <div style={{ marginBottom: 24 }}>
          <label style={{ display: 'block', marginBottom: 6, fontSize: 14 }}>I am a</label>
          <select
            value={role}
